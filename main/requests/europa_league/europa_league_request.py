...
for year in years:
    ...
    url = f"https://v3.football.api-sports.io/fixtures?league=3&season={year}"
    ...
    with open(f'../../resources/europa_league/europa_league_{year}.json', 'w', encoding='utf-8') as outfile:
